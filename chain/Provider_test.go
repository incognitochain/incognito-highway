...
func (_m *Provider) SetSingleBlockByHeight(ctx context.Context, req chain.RequestBlockByHeight, data common.ExpectedBlk) error {
	ret := _m.Called(ctx, req, data)

	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, chain.RequestBlockByHeight, common.ExpectedBlk) error); ok {
		r0 = rf(ctx, req, data)
	} else {
		r0 = ret.Error(0)
	}
...
func (_m *Provider) StreamBlkByHeight(ctx context.Context, req chain.RequestBlockByHeight, blkChan chan common.ExpectedBlk) error {
	ret := _m.Called(ctx, req, blkChan)

	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, chain.RequestBlockByHeight, chan common.ExpectedBlk) error); ok {
