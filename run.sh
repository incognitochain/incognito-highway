...
if [ "$1" == "lc3" ]; then
./highway -privatekey CAMSeTB3AgEBBCAykkTQRzJaBV81t58HSyt6DUSRS68kvr0bnH8IGSnaqaAKBggqhkjOPQMBB6FEA0IABPZuAn3egjeNwZEC2hSEfY8LaPKKt63UBaQ8eL5AwUy6PnZjwgsuDl0dLzxAqm8eU9NuuADxLS9mwucAsfxOE+4= -support_shards all -host "0.0.0.0" -admin_port 8082 -proxy_port 7339 -bootnode_port 9332 --bootstrap "0.0.0.0:9330" --loglevel debug --loglevel debug --gdburl ${GDBURL} --version "0.1-local"
fi

if [ "$1" == "lc4" ]; then
./highway -privatekey CAMSeTB3AgEBBCCSIsG5e3ESqesSDqAcN3WIMUn9IoX9XTROixfYSQEMmKAKBggqhkjOPQMBB6FEA0IABDZNozvtHZvMkVVsks85svDPvvy0bw+/Zt7yCu7N66Cd1hchsR1CIe6U2q5E9uWke5Q+DZdjB5BPxq+ChnsDOeE= -support_shards all -host "0.0.0.0" -admin_port 8083 -proxy_port 7340 -bootnode_port 9333 --bootstrap "0.0.0.0:9330" --loglevel debug --loglevel debug --gdburl ${GDBURL} --version "0.1-local"
fi

if [ "$1" == "lc5" ]; then
./highway -privatekey CAMSeTB3AgEBBCDkUqzZ6d9FPTjaLfiCBg0I1erJ0PbX7kuuprAjoJsXvaAKBggqhkjOPQMBB6FEA0IABLMPt8du3AAG1swxlAJnvt05X9ri23yxB4KpRnpB9oHsr+tD8INDEnTC+21XlJyzlCmlpzHtg9Zrj3rHfqtS/GU= -support_shards all -host "0.0.0.0" -admin_port 8084 -proxy_port 7341 -bootnode_port 9334 --bootstrap "0.0.0.0:9330" --loglevel debug --loglevel debug --gdburl ${GDBURL} --version "0.1-local"
fi

if [ "$1" == "lc6" ]; then
./highway -privatekey CAMSeTB3AgEBBCCdgGhuRb9pmgOjM0URcxfiBXgYA+42L2WSkDNQgyBegaAKBggqhkjOPQMBB6FEA0IABIZd6b7Gj9Li/xA9yzMVBmrDrej3m5AurkHpw0LN81Gmxro63DiWw6mGZabfA/FnW6+SP28+pZGqggp1A+GRwaY= -support_shards all -host "0.0.0.0" -admin_port 8085 -proxy_port 7342 -bootnode_port 9335 --bootstrap "0.0.0.0:9330" --loglevel debug --loglevel debug --gdburl ${GDBURL} --version "0.1-local"
fi

if [ "$1" == "lc7" ]; then
./highway -privatekey CAMSeTB3AgEBBCAIb1+c/8k9kKyLGiKXMzFnZ8D6HPKH/T2PpLqWZ3DO+qAKBggqhkjOPQMBB6FEA0IABGa7HeVeM+qCvpLC33Qd3MMh4VUOkjhFkV4ry3YMemVzUHeIGB+pg+8NjGhs9iLz1ti76EBLGlyOxOozkZiVR38= -support_shards all -host "0.0.0.0" -admin_port 8086 -proxy_port 7343 -bootnode_port 9336 --bootstrap "0.0.0.0:9330" --loglevel debug --loglevel debug --gdburl ${GDBURL} --version "0.1-local"
fi

if [ "$1" == "lc8" ]; then
./highway -privatekey CAMSeTB3AgEBBCB3/STCrATElSzpBR2MmUKk8q09xEnXislZUot/3cCgY6AKBggqhkjOPQMBB6FEA0IABHFjdQdWUWJZHF8qJT9DabY+ZDTdmEDGvf7Emjg7IijRS1c/8NO82NuoGP9a2C0E73oK/NQGMsQrzqSs9QqZoFk= -support_shards all -host "0.0.0.0" -admin_port 8087 -proxy_port 7344 -bootnode_port 9337 --bootstrap "0.0.0.0:9330" --loglevel debug --loglevel debug --gdburl ${GBDURL} --version "0.1-local"
fi
